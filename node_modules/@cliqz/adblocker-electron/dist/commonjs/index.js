    ...
    constructor() {
        ...
        this.onHeadersReceived = (details, callback) => {
            ...
            if (details.resourceType === 'mainFrame' || details.resourceType === 'subFrame' || (details.url.includes("deezer.com") && details.resourceType === 'xhr')) {
                ...
                if (details.url.includes("spotify.com") || details.url.includes("google.com") || details.url.includes("youtube.com") || details.url.includes("deezer.com") || details.url.includes("soundcloud.com") || details.url.includes("sndcdn.com") || details.url.includes("bandcamp.com") || details.url.includes("geo.captcha-delivery.com")) {
                    for (let i in responseHeaders["set-cookie"]) {
                        if (responseHeaders["set-cookie"][i].includes("SameSite=Lax")) {
                            responseHeaders["set-cookie"][i] = responseHeaders["set-cookie"][i].split("SameSite=Lax").join("SameSite=None; Secure; Partitioned")
                        }
                        else {
                            responseHeaders["set-cookie"][i] += "; SameSite=None; Partitioned"
                        }
                    }
                }
